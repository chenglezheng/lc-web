<template>
    <div class="side-nav" :class="layout">
        <el-menu style="border-bottom: 0px;" router ref="navbar" :default-active="defActive" :mode="navMode" menu-trigger="click" @select="selectMenu" @open="openMenu" @close="closeMenu" unique-opened>
